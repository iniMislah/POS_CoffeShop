...
productRoutes.post("/:productId/variants", authorize(UserRole.ADMIN), validateRequest(productVariantParamSchema, "params"), validateRequest(variantSchema), asyncHandler(productsController.createVariant));
productRoutes.put("/variants/:variantId", authorize(UserRole.ADMIN), validateRequest(productVariantParamSchema, "params"), validateRequest(variantSchema.partial()), asyncHandler(productsController.updateVariant));
productRoutes.delete("/variants/:variantId", authorize(UserRole.ADMIN), validateRequest(productVariantParamSchema, "params"), asyncHandler(productsController.deleteVariant));
