...
import { cashPaymentSchema, orderIdParamSchema, qrisWebhookSchema } from "./payments.validation";
...
privateRouter.post("/orders/:orderId/qris", authorize(UserRole.ADMIN, UserRole.CASHIER), validateRequest(orderIdParamSchema, "params"), asyncHandler(paymentsController.createQrisPayment));
